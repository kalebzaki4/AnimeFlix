...
const PaginaDetalhes = () => {
      ...
      <div className="assistir-episodio" style={{ background: "#181818", minHeight: "100vh", color: "#fff" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 18 }}>
          ...
          <div style={{
            ...
            {/* Se houver link de vídeo, exibe player. Caso contrário, mostra imagem */}
  ...
  return (
    <div className="detalhes" style={{ background: "#181818" }}>
      {alert && (
        <Alert
      ...
      <div className="detalhes-titulo" style={{ alignItems: "center", gap: 8 }}>
        <h1 className="Title" style={{ margin: 0 }}>{animeDetails.title}</h1>
        {isAuthenticated && (
          <button
          ...
          <div className="episodios-container">
            {episodes.slice(0, visibleEpisodes).map((episodio, index) => (
              <div
                ...
                style={{
                  cursor: "pointer",
                  background: "#23272f", // cor escura para o card
                  color: "#fff"
                }}
